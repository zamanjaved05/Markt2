...
@endsection
@section('title','AsmaMarkt || PRODUCT DETAIL')
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="">{{__('product.Shop Details')}}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="product-des">
                                ...
                                <div class="product-buy">
                                    ...
                                    @endif
                                    <p class="availability">{{__('product.Stock :')}} @if($product_detail->stock>0)
                                                ...
                                                <div class="col-12">
                                                        ...
                                                        <div class="review-inner">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-12 col-12">
                                                                            <div class="form-group">
                                                                                <label>{{__('product.Write a review')}}</label>
                                                                        ...
                                                                        <div class="col-lg-12 col-12">
                                                                            <div class="form-group button5">
                                                                                <button type="submit"
                                                                                        class="btn">{{__('product.Submit')}}</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                            @else
                                                                <p class="text-center p-5">
                                                                    {{__('product.You need to')}} <a
                                                                        href="{{route('login.form')}}"
                                                                        style="color:rgb(54, 54, 204)">{{__('product.Login')}}</a> {{__('product.OR')}}
                                                                    <a style="color:blue"
                                                                       href="{{route('register.form')}}">{{__('product.Register')}}</a>
                                                    ...
                                                    <div class="ratting-main">
                                                        <div class="avg-ratting">
                                                            ...
                                                            @endphp --}}
                                                            <h4>{{ceil($product_detail->getReview->avg('rate'))}} <span>({{__('product.Overall')}})</span>
                                                            </h4>
                                                            <span>{{__('prodyct.Based on')}} {{$product_detail->getReview->count()}} {{__('product.Comments')}}</span>
                                                        </div>
                                ...
                                <div class="single-product">
                                    <div class="product-img">
                                        <a href="{{route('product-detail',$data->slug)}}">
                                            ...
                                            <span class="price-dec">{{$data->discount}} % {{__('product.Off')}}</span>
                                        ...
                                        <div class="button-head">
                                            <div class="product-action">
                                                ...
                                                <a title="Compare" href="#"><i
                                                        class="ti-bar-chart-alt"></i><span>{{__('product.Add to Compare')}}</span></a>
                                            </div>
                                            <div class="product-action-2">
                                                <a title="Add to cart" href="#">{{__('product.Add to cart')}}</a>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            <div class="quickview-content">
                                <h2>{{__('product.Flared Shift Dress')}}</h2>
