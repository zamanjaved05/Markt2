...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          <label for="inputPhoto1" class="col-form-label">Photo1 <span class="text-danger">*</span></label>
          <div class="input-group">
              <span class="input-group-btn">
                  <a id="lfm1" data-input="thumbnail1" data-preview="holder1" class="btn btn-primary text-white">
                  <i class="fas fa-image"></i> Choose1
                  </a>
              </span>
          <input id="thumbnail1" class="form-control" type="text" name="photo1" value="{{$product->photo1}}">
        </div>
...
<!--<link rel="stylesheet" href="{{asset('backend/summernote/css/bootstrap-select.css')}}">-->
<link rel="stylesheet" href="{{asset('backend/summernote/bootstrap-select.css')}}">
...
{{--<script src="{{asset('backend/summernote/bootstrap-select.min.js')}}"></script>
