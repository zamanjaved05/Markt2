                ...
                <tr>
                    ...
                    <td>
                     <ul style="list-style:none">
                          @for($i=1; $i<=5;$i++)
                          @if($review->rate >=$i)
                            <li style="float:left;color:#ff0000;"><i class="fa fa-star"></i></li>
                          @else
                            <li style="float:left;color:#ff0000;"><i class="far fa-star"></i></li>
                          @endif
                        @endfor
                     </ul>
                    </td>
...
@push('styles')
  ...
  <link href="<?php echo e(asset('backend/vendor/sweetalert.min.css')); ?>" rel="stylesheet">
